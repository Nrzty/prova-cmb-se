...
class ProcessDispatchCreatedJob implements ShouldQueue
{
    ...
    public function handle(ProcessDispatchCreatedService $processDispatchCreatedService): void
    {
        ...
        try {
            ...
            $processDispatchCreatedService->process($this->eventInboxId);
